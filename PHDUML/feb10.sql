...
insert  into `booking`(`b_id`,`op_id`,`u_id`,`sts`,`b_date`) values (1,1,1,'pending','2019-12-12'),(2,3,1,'pending','2020-01-27'),(3,3,3,'reject','2020-01-28'),(4,3,3,'pending','2020-01-28'),(5,3,3,'confirm','2020-01-28'),(6,3,3,'confirm','2020-02-28'),(7,3,3,'reject','2020-02-25'),(8,3,4,'pending','2020-01-28'),(9,4,4,'pending','2020-02-10');
...
insert  into `complaint`(`id`,`l_id`,`sub`,`complaint`,`c_date`,`reply`) values (1,1,'1','1','2005-01-23','pending'),(2,2,'52','15','2020-01-23','654'),(3,2,'34','33','2020-01-23','pending'),(4,3,'54','45','2020-01-23','pending');
...
insert  into `rating`(`id`,`did`,`lid`,`date`,`rate`,`b_id`) values (1,3,11,'2009-09-29',3,NULL),(2,2,3,'2020-02-10',4,NULL),(3,2,3,'2020-02-10',3,NULL);
...
insert  into `user`(`u_id`,`lid`,`img`,`u_name`,`age`,`ph_no`,`email`,`gender`,`u_place`,`u_dist`) values (2,2,'20200121-135920DSC_0108.JPG','shaniiiiii',24,987654321,'dd','Male','kalpett','Wayan'),(3,3,'20200122-110349DSC_0104.JPG','shanith',24,9876543210,'kkddff@mnjs','Male','kalpetta','Wayanad'),(4,14,'20200205-145839pp.jpg','shanith',24,8714344727,'kkshanit@gmail.com','Male','kalpetta','Kannur'),(5,18,'20200209-220555IMG_7319.JPG','shanith',24,9876543210,'shanithkk123@gmail.com','Male','kalpetta','Wayanad');
